export const groupDummy = {
    ...
    tweets: [{ author: 'bae', content: 'my wishlist for red velvet:\n- #YERI, #SEULGI solo debut\n- #WENDY rnb album \n- #JOY original album\n- wendy ost for a popular kdrama\n- US label!!!!\n- group ost\n- #IRENE kdrama, cfs, mag shoots, brand deals\n- group mag shoot\n- killing voice, it\'s live guesting\n- dance practice vidsd', avatar: '/static/images/avatar/1.jpg' },
    { author: 'rvchart', content: "@RVsmtown's Bad Boy re-entered Billboard World Digital Song Sales chart for the week of November 13, 2021 Party popper", avatar: "/static/images/avatar/2.jpg", image: "https://pbs.twimg.com/media/FDywImZUUAQfO8X?format=jpg&name=900x900" },
    { author: "dip✨", content: "throwback to the one of the best concert in k-pop history... la rouge concert was for the history books @RVsmtown", avatar: "/static/images/avatar/3.jpg", image: "https://pbs.twimg.com/media/FD0Mw8eVcAAhNIn?format=jpg&name=medium" }],
    youtubes: [
...
export const memberDummy = {
    basicInfo: {
        ...
        info: { name: { kor: '강슬기', eng: 'Seulgi' }, groups: [{ name: 'Red Velvet' }], birth: '1994.02.10', debut: '2014.08.01' },
